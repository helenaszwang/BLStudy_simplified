...
function HeadphoneLoopBegin(HeadphoneLoopScheduler) {
  ...
  for (const thisHeadphone of Headphone) {
...
function WordTaskLoopBegin(WordTaskLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisWordTask of WordTask) {
...
function WordMSTLoopLoopBegin(WordMSTLoopLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisWordMSTLoop of WordMSTLoop) {
...
function SoundTaskLoopBegin(SoundTaskLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisSoundTask of SoundTask) {
...
function SoundPracticeLoopLoopBegin(SoundPracticeLoopLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisSoundPracticeLoop of SoundPracticeLoop) {
...
function MSTSoundLoopLoopBegin(MSTSoundLoopLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisMSTSoundLoop of MSTSoundLoop) {
...
function SimilarityRatingTaskLoopBegin(SimilarityRatingTaskLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisSimilarityRatingTask of SimilarityRatingTask) {
...
function SimilarityRatingLoopLoopBegin(SimilarityRatingLoopLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisSimilarityRatingLoop of SimilarityRatingLoop) {
...
function LabelingTaskLoopBegin(LabelingTaskLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisLabelingTask of LabelingTask) {
...
function SoundLabelLoopLoopBegin(SoundLabelLoopLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisSoundLabelLoop of SoundLabelLoop) {
...
function MSTWordRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of MSTWordComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function End1RoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of End1Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function Welcome2_2RoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of Welcome2_2Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function SoundPracticeRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of SoundPracticeComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function SoundPracticeFeedbackRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of SoundPracticeFeedbackComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function MSTSoundStartRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of MSTSoundStartComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function MSTSoundResponseRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of MSTSoundResponseComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function SimilarityPresentationRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of SimilarityPresentationComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function SimlarityResponseRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of SimlarityResponseComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function SoundLabelingRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of SoundLabelingComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
